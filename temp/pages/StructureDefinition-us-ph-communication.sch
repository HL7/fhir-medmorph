...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Communication">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/fhir-medmorph/StructureDefinition/ext-responseMessageStatus']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/fhir-medmorph/StructureDefinition/ext-responseMessageStatus': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:received) &gt;= 1">received: minimum cardinality of 'received' is 1</sch:assert>
